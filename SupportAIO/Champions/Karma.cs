...
namespace SupportAIO.Champions
{
    class Karma : Champion
    {
        ...
        protected override void Farming()
        {
            ...
            foreach (var minion in GameObjects.Jungle.Where(m => m.IsValidTarget(Q.Range)).ToList())
            {
                ...
                bool useQ = RootMenu["farming"]["useq"].GetValue<MenuBool>().Enabled;
                bool useW = RootMenu["farming"]["usew"].GetValue<MenuBool>().Enabled;
    ...
    protected override void Drawings()
        ...
        protected override void SetSpells()
        {
            ...
            Q.SetSkillshot(0.25f, 60, 1700, true, SpellType.Line);
        }
    }
}
