...
namespace SupportAIO.Champions
{
    class Zyra : Champion
    {
        ...
        protected override void SemiR()
        {
            ...
            if (RootMenu["misc"]["autoe"].GetValue<MenuBool>().Enabled)
            {
        ...
        protected override void Drawings()
        {
            ...
            if (RootMenu["drawings"]["drawseed"].GetValue<MenuBool>().Enabled)
            {
        ...
        protected override void SetSpells()
        {
            ...
            Q.SetSkillshot(0.85f, 140f, 3000, false, SpellType.Line,  HitChance.None);
            W.SetSkillshot(0.25f, 150, 1000f, false, SpellType.Circle,  HitChance.None);
            E.SetSkillshot(0.25f, 60, 1300f,  false, SpellType.Line,  HitChance.None);
            R.SetSkillshot(0.3f, 60, 1000f, false, SpellType.Circle);
        }
    }
}
