namespace SupportAIO.Common
{
    ...
    internal static class Extensions
    {
        ...
        {
            return TargetSelector.GetTargets(range, DamageType.Magical);
        }
        ...
        {
            return TargetSelector.GetTargets(spell.Range, DamageType.Magical).FirstOrDefault(t => t.IsValidTarget());
        }
        public static AIHeroClient GetBestKillableHeroEQ(DamageType damageType = DamageType.True, bool ignoreShields = false)
        {
            return TargetSelector.GetTargets(1800, DamageType.Magical).FirstOrDefault(t => t.IsValidTarget());
        }
        /// <summary>
